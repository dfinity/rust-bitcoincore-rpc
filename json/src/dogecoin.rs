...
// This is not defined in dogecoin::bip32
#[derive(Clone, PartialEq, Eq, Debug, Deserialize, Serialize)]
pub struct XKeyIdentifier(bitcoin::hashes::hash160::Hash);
...
pub struct GetWalletInfoResult {
    ...
    pub hd_seed_id: Option<XKeyIdentifier>,
...
pub struct GetMiningInfoResult {
    ...
    pub chain: Network,
    pub warnings: Option<StringOrStringArray>,
}
